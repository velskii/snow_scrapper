...
public class OrderRecyclerViewAdapter  extends RecyclerView.Adapter<OrderRecyclerViewAdapter.ViewHolder> {
    ...
    public OrderRecyclerViewAdapter(List<Map<String, String>> dataSet) {
        mDataSet = dataSet;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private static final String TAG = "OrderRecyclerViewHolder";
    ...
    @Override
    public OrderRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        // Create a new view.
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.order_list_item, viewGroup, false);

        return new OrderRecyclerViewAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(OrderRecyclerViewAdapter.ViewHolder viewHolder, @SuppressLint("RecyclerView") final int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment fragment = new OrderDetailsFragment( mDataSet.get(position).get("id") );
