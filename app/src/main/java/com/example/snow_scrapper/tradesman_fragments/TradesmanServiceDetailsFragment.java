...
public class TradesmanServiceDetailsFragment extends Fragment {
    ...
    public static TradesmanServiceDetailsFragment newInstance(String param1, String param2) {
        TradesmanServiceDetailsFragment fragment = new TradesmanServiceDetailsFragment();
